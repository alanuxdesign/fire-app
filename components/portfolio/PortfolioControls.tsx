...
export function PortfolioControls({
  ...
  return (
    <div className="space-y-3 border-b border-stone-200/80 pb-4 dark:border-zinc-800">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <select
          ...
          className="rounded-lg border border-stone-300 bg-white px-3 py-1.5 text-sm font-medium text-slate-800 outline-none focus:border-slate-500 focus:ring-1 focus:ring-slate-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
        >
