          ...
          {lines.map((line, i) => (
            <div key={i} className="flex gap-2">
              <select
                ...
                className="min-w-0 flex-1 rounded-lg border border-hairline px-2 py-1.5 text-sm"
              >
                {categories.map((c) => (
              ...
              <input
                ...
                className="w-24 rounded-lg border border-hairline px-2 py-1.5 text-sm"
              />
              <button
                type="button"
                onClick={() => setLines(lines.filter((_, j) => j !== i))}
                className="rounded p-1.5 text-ink-secondary hover:bg-canvas-sunken"
              >
